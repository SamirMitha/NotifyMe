...
[![PyPi Link](https://img.shields.io/badge/pypi-1.0.2-blue)](https://pypi.org/project/notifyme-traveltimer/)
...
Use the package manager [pip](https://pip.pypa.io/en/stable/) to install notifyme-traveltimer.
